...
CREATE TABLE dq_rules_asset_map (
	asset_map_id   varchar(30) default ('DQRM-'||lpad(((nextval('dq_rules_asset_map_seq')::text)),20,'0')) ,
	rule_id varchar(30) NOT NULL, -- Rule Id
	database_name varchar(255) NOT NULL, -- database_name
	...
	CONSTRAINT dq_rules_asset_map_partition_keys_key UNIQUE (partition_keys),
	CONSTRAINT dq_rules_asset_map_pkey PRIMARY KEY (asset_map_id),
	CONSTRAINT dq_rules_asset_map_rule_id_fkey FOREIGN KEY (rule_id) REFERENCES data_quality_rules(rule_id)
);
