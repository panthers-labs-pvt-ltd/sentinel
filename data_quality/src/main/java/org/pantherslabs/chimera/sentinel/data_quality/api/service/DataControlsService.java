...
import org.pantherslabs.chimera.sentinel.data_quality.api.mapper.generated.DataControlsMapper;
...
import static org.pantherslabs.chimera.sentinel.data_quality.api.mapper.generated.DataControlsDynamicSqlSupport.dataControls;
...
public class DataControlsService {
    ...
    public DataControls getControlById(String id) {
        ...
        return dataControlsMapper.selectByPrimaryKey(id)
                .orElseThrow(() -> new ChimeraException("APIException.404",
                        Map.of("exception", "Control Id " + id + " Not Found"),
                        null,
    ...
    public DataControls updateControl(String id, DataControls updatedControl) {
