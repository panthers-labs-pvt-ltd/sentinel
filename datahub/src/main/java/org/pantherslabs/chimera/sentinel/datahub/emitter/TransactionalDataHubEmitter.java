...
public class TransactionalDataHubEmitter {
    ...
    public TransactionalDataHubEmitter() {
     ...
     * @return true if all succeeded, false if rollback was triggered
     */
        ...
        for (MetadataChangeProposal proposal : proposals) {
            try {
                ...
                if (response.isSuccess()) {
                    ...
                    ErrorDetails errorDetails = ErrorExtractor.extractErrorDetails(rawError);
