...
import org.pantherslabs.chimera.sentinel.datahub.dto.OwnerRequest;
...
import org.pantherslabs.chimera.sentinel.datahub.service.OwnershipService;
...
public class OwnershipController {
    ...
    public ResponseEntity<?> addOwners(@RequestBody OwnerRequest request) {
        ...
        try {
            ...
            result = OwnershipService.createOwners(
                    urn,
...
/*            List<String> allOwnersToRemove = request.getOwnersInfo().values().stream()
            ...
            result = ownershipService.removeOwners(
