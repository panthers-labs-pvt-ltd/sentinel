...
public class DatasetService {
    ChimeraLogger DatahubLogger = ChimeraLoggerFactory.getLogger(DatasetService.class);
...
//======================Testing for Query
          ...
          //TODO
            ...
            if (datasetsInfo.getGlossaryTerm() != null && !datasetsInfo.getGlossaryTerm().isEmpty()) {
                ...
                new DataProductService().addAssetToDataProduct(datasetsInfo.getDataProductName(), datasetUrn.toString());
